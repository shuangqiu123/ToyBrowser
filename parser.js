...
function computeCSS(element) {
    // use slice to duplicate stack array
...
//assume simple css selector only
// one class
// .a
// #a
// div
...
function emit(token) {
    ...
    if (token.type === "startTag") {
        ...
        // CSS information has been gathered
        // ignore css in the body for recalculation
        computeCSS(element);
